...
describe("orderInvoicePreviewRecordAction (Core 4.3.1 / 7.7.0)", () => {
  afterEach(() => {
  ...
  it("opens the invoice board when Loop_09 is present", async () => {
    ...
    const board = element.shadowRoot.querySelector(
      "c-order-invoice-preview-wizard"
    );
    expect(board).toBeTruthy();
    expect(board.recordId).toBe("a0H000000000001AAA");
  });
});
